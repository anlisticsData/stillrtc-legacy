...
/**
 * Created by Still Technology and Development Team on 31/10/2019.
 */
public class GpsPco  extends Service implements LocationListener {
    ...
    public void stopUsingGPS(){
        if(locationManager != null){
            locationManager.removeUpdates(GpsPco.this);
        }
    }
    /**
