...
public class LocationInforUserDialog extends Dialog implements android.view.View.OnClickListener {
    private final OnResponse onResponse;
    public Activity c;
    public Dialog d;
    public Button ok,moreInfoButton;

    public LocationInforUserDialog(@NonNull Activity context,OnResponse onResponse) {
        super(context);
        this.c = context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.location_layout_information);
