...
public class CabinAudioEntitySqlite extends SQLiteOpenHelper {
    public static final int DATABASE_VERSION = 1;
    public static final String DATABASE_NAME ="cabinSoundDatabase.db";
    public CabinAudioEntitySqlite(@Nullable Context context ) {
