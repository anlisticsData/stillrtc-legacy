...
/**
 * Created by Still Technology and Development Team on 08/10/2019.
 */
public class PictureGrafica {
    ...
    public PictureGrafica(String path_file, String tb_retirada_gf_codigo, String device, String user, String loc) {
