...
public class MapsActivity extends AppCompatActivity
    ...
    private static final String JOB_TAG = "GPS_Oreo";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        appConfig = new ApiConfig(MapsActivity.this);
    ...
    public void recuperarZonasStills(String ids) {
        ...
        if (Utils.isNetworkAvailable(MapsActivity.this) && Utils.isOnline()) {
            /*
        ...
        Toast.makeText(this, R.string.alert_info_loading_current_area, Toast.LENGTH_LONG).show();
        ...
        Call<Zone.Result> call = apiService.resgatarZonasPorIdsAPI(
                        ...
                        for (Zone z : listZone) {
                            ...
                            for (String part : parts) {
                                ...
                                try {
                                    ...
                                    if (latlng.length == 2) {
                                        if (!latlng[0].trim().equals("") && !latlng[1].trim().equals("")) {
   ...
   /*     ibtnAllPicture = (ImageButton) findViewById(R.id.ibtnAllPicture);
    ...
    public void listenerUI() {
        btnStart.setOnClickListener(new View.OnClickListener() {/*   mRecyclerView = (RecyclerView) findViewById(R.id.recycler_view);
...
/*
            ...
            if(Build.VERSION.SDK_INT <=25) {
                ...
                bundle.putInt("timeout", 120); // A forma de passar parâmetro no Oreo é diferente

                bundle.putString( "deviceIdentifier", deviceIdentifier );
                bundle.putInt( "deliveryFragmentId", deliveryFragmentId );


                FirebaseJobDispatcher mDispatcher = new FirebaseJobDispatcher(new GooglePlayDriver(MapsActivity.this));
                Job myJob = mDispatcher.newJobBuilder()
                        .setService(OreoGPSService.class) // A forma de construir a classe no Oreo é diferente
                        .setTag(JOB_TAG)
                        .setRecurring(false)
...
*/
            ...
            //startService( new Intent( MapsActivity.this, GpsServices.class ) );
...
//                0)
    ...
    private void regatarLocalizacaoDispositivo() {
        ...
        if (mLocationPermissionGranted) {
            ...
            try {
                ...
                //Toast.makeText( this,"Lat "+lastLat +"Lon "+lastLng,Toast.LENGTH_LONG ).show();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
      ...
      /*  if (resultCode != RESULT_OK) {registerEndOperationOf50Plus1
...
//2022
            case UploadFile.REQUEST_CODE_TAKE_PICTURE:
                try {
                    ...
                    System.out.println("# 7 "+e.getLocalizedMessage());
