...
import br.com.stilldistribuidora.stillrtc.ui.activities.MapWebViewActivity;
import br.com.stilldistribuidora.stillrtc.ui.activities.MapsActivity;
import br.com.stilldistribuidora.stillrtc.ui.activities.OperationDetailsActivity;
...
public class OperationAdapter extends RecyclerView.Adapter<OperationAdapter.ViewHolderItem> {
    ...
    public OperationAdapter(Activity context, ArrayList<Operation> phraseArrayList, Boolean empty) {
    ...
    @Override
    public OperationAdapter.ViewHolderItem onCreateViewHolder(ViewGroup parent, int viewType) {
        View v;
        if (viewType == 0) {
            v = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_empty, parent, false);
        } else {
            v = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_delivery_fragment, parent, false);
        }
        return new OperationAdapter.ViewHolderItem(v);
    }



    @Override
    public void onBindViewHolder(final OperationAdapter.ViewHolderItem customViewHolder, @SuppressLint("RecyclerView") final int position) {
            ...
            customViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    try {
                        ...
                        if (context.getClass() == DeliveriesActivity.class) {
    ...
    public void CheckStatusOperation_(final OperationAdapter.ViewHolderItem customViewHolder,String idDelyvery,String dtcAoperacao) {
