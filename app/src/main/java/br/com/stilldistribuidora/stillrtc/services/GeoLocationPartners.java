...
public class GeoLocationPartners extends Service implements LocationListener {
    ...
    public GeoLocationPartners(Context context) {
    ...
    public void stopUsingGPS(){
        if(locationManager != null){
            locationManager.removeUpdates(GeoLocationPartners.this);
        }
    }
    /**
